...
public class LifeSpan {
    ...
    public String toString() {
        ...
        sb.append(LifeSpan.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("ended");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LifeSpan) == false) {
            return false;
        }
        LifeSpan rhs = ((LifeSpan) other);
