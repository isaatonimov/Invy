...
public class AudioStream {
    ...
    public String toString() {
        ...
        sb.append(AudioStream.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("url");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AudioStream) == false) {
            return false;
        }
        AudioStream rhs = ((AudioStream) other);
