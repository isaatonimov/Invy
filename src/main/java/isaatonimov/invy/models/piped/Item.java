...
public class Item {
    ...
    public boolean equals(Object other) {
        ...
        Item rhs = ((Item) other);
        return ((((((((((((((((this.thumbnail == rhs.thumbnail)||((this.thumbnail!= null)&&this.thumbnail.equals(rhs.thumbnail)))&&((this.uploaderAvatar == rhs.uploaderAvatar)||((this.uploaderAvatar!= null)&&this.uploaderAvatar.equals(rhs.uploaderAvatar))))&&((this.uploaderVerified == rhs.uploaderVerified)||((this.uploaderVerified!= null)&&this.uploaderVerified.equals(rhs.uploaderVerified))))&&((this.shortDescription == rhs.shortDescription)||((this.shortDescription!= null)&&this.shortDescription.equals(rhs.shortDescription))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.uploaderUrl == rhs.uploaderUrl)||((this.uploaderUrl!= null)&&this.uploaderUrl.equals(rhs.uploaderUrl))))&&((this.uploadedDate == rhs.uploadedDate)||((this.uploadedDate!= null)&&this.uploadedDate.equals(rhs.uploadedDate))))&&((this.url == rhs.url)||((this.url!= null)&&this.url.equals(rhs.url))))&&((this.duration == rhs.duration)||((this.duration!= null)&&this.duration.equals(rhs.duration))))&&((this.uploaderName == rhs.uploaderName)||((this.uploaderName!= null)&&this.uploaderName.equals(rhs.uploaderName))))&&((this.uploaded == rhs.uploaded)||((this.uploaded!= null)&&this.uploaded.equals(rhs.uploaded))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.isShort == rhs.isShort)||((this.isShort!= null)&&this.isShort.equals(rhs.isShort))))&&((this.views == rhs.views)||((this.views!= null)&&this.views.equals(rhs.views))));
    }
