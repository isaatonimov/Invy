...
public class VideoThumbnail {
    ...
    public String toString() {
        ...
        sb.append(VideoThumbnail.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("quality");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VideoThumbnail) == false) {
            return false;
        }
        VideoThumbnail rhs = ((VideoThumbnail) other);
