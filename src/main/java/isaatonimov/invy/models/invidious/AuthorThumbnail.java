...
public class AuthorThumbnail {
    ...
    public String toString() {
        ...
        sb.append(AuthorThumbnail.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("url");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AuthorThumbnail) == false) {
            return false;
        }
        AuthorThumbnail rhs = ((AuthorThumbnail) other);
