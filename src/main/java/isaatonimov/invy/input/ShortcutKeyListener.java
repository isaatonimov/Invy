...
{
	private final List<Integer> 						keyEventQueue 			= new ArrayList<>();
	private final HashMap<int[], HelperService> 			shortcutActionMap 		= new HashMap<int[], HelperService>();
	private final HashMap<HelperService, Worker.State>	serviceStates 			= new HashMap<>();
	private final HashMap<Integer, HelperService> 		simpleShortcutActionMap 	= new HashMap<Integer, HelperService>();
